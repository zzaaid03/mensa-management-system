    ...
    try:
        ...
        meals = [
            ...
            models.Meal(
                ...
                price=4.50,
                category="main",
                image_url="https://images.unsplash.com/photo-1598866594230-a7c12756260f?w=600",
                calories=650,
                protein=28.5,
                carbs=75.0,
                fat=18.0,
            ...
            models.Meal(
                ...
                price=5.20,
                category="main",
                image_url="https://images.unsplash.com/photo-1599921841143-819065a55cc6?w=600",
                calories=720,
                protein=42.0,
                carbs=45.0,
                fat=28.0,
            ...
            models.Meal(
                ...
                price=4.00,
                category="main",
                image_url="https://images.unsplash.com/photo-1743187363021-2a89f881937f?w=600",
                calories=520,
                protein=18.0,
                carbs=65.0,
                fat=20.0,
            ...
            models.Meal(
                ...
                price=4.80,
                category="main",
                image_url="https://images.unsplash.com/photo-1709429790175-b02bb1b19207?w=600",
                calories=700,
                protein=32.0,
                carbs=62.0,
                fat=26.0,
            ...
            models.Meal(
                ...
                price=1.50,
                category="drink",
                image_url="https://images.unsplash.com/photo-1601055903647-ddf1ee9701b7?w=600",
                calories=120,
                protein=0.2,
                carbs=28.0,
                fat=0.1,
            ...
            models.Meal(
                ...
                price=1.80,
                category="dessert",
                image_url="https://images.unsplash.com/photo-1616151030755-76f6cd987a06?w=600",
                calories=380,
                protein=5.0,
                carbs=55.0,
                fat=16.0,
